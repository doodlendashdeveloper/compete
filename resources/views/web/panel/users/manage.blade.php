...
@push('css')
    ...
    <link href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-toggle/2.2.2/css/bootstrap-toggle.min.css"
        rel="stylesheet">
    <link href="{{ URL::asset('admin-panel/assets/libs/select2/css/select2.min.css') }}" rel="stylesheet" type="text/css" />
@endpush
...
@push('custom-scripts')
    ...
    <script src="{{ URL::asset('admin-panel/assets/libs/select2/js/select2.full.min.js') }}"></script>
    <script>
